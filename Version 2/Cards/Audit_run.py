...
def main():
    ...
    os.system('cmd /c "robot -v input_file:"'+sys.argv[2]+'" -v day:"'+date+'" -l audit_card_log.html -r audit_card_report.html audit_card.robot > audit_card_debug_details"')
    ...
    os.system('cmd /c "robot -v day:"'+date+'" -l fetch_log.html -r fetch_report.html fetch_file.robot > fetch_file_debug_details"')
    logger.info("Logs of audit card file are collected in audit_card_log.html and audit_card_report.html files..")
    time.sleep(10)
    print("Summarizing...")
