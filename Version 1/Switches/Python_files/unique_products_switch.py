...
Product=fetch.extract(input_file,2)
Date=fetch.extract(input_file,3)
Version=fetch.extract(input_file,4)
Download_page=fetch.extract(input_file,6)
Description=fetch.extract(input_file,7)
Severity=fetch.extract(input_file,8)
Os=fetch.extract(input_file,5)
Market_name=fetch.extract(input_file,1)
